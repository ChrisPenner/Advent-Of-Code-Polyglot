...
main() ->
	[A1,A2,A3,A4,A5] = [4,-2,0,0,5],
	[B1,B2,B3,B4,B5] = [0,5,-1,0,8],
	[C1,C2,C3,C4,C5] = [-1,0,5,0,6],
	[D1,D2,D3,D4,D5] = [0,0,-2,2,1],

	Combos = generate_combos(A5,B5,C5,D5),
